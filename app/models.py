...
class User(UserMixin, db.Model):
    ...
    amt_id = db.Column(db.String(128))
    posts = db.relationship('Post', backref='author', lazy='dynamic')
    about_me = db.Column(db.String(140))
    last_seen = db.Column(db.DateTime, default=datetime.utcnow)
    # Form questions values
    extra = db.Column(db.String(120))
    trust = db.Column(db.String(120))
    lazy = db.Column(db.String(120))
    relax = db.Column(db.String(120))
    art = db.Column(db.String(120))
    social = db.Column(db.String(120))
    fault = db.Column(db.String(120))
    job = db.Column(db.String(120))
    nervous = db.Column(db.String(120))
    imagination = db.Column(db.String(120))
    ability = db.Column(db.String(120))
    # BigFive
    extraversion = db.Column(db.String(120))
    agreeableness = db.Column(db.String(120))
    conscientiousness = db.Column(db.String(120))
    neuroticism = db.Column(db.String(120))
    openness = db.Column(db.String(120))
    # Stable match
    ...
    performance = db.Column(db.String(120))
